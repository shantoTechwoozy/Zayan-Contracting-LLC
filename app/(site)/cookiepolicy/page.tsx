...
import { FaCookie, FaInfoCircle, FaPhone, FaEnvelope } from 'react-icons/fa';
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-600">
            Zayan Contracting LLC&apos;s website uses cookies to enhance your experience. This Cookie Policy explains what cookies are, how we use them, and how you can control them.
          </p>
        </section>
