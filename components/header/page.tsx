          ...
          <div className="md:flex md:items-center md:gap-12">
            <nav aria-label="Global" className="hidden md:block">
              <ul className="flex items-center gap-6 text-sm">
                ...
                <li>
                  <a className="text-gray-700 transition hover:text-gray-900" href="#"> Services </a>
                </li>
                <li>
                  <a className="text-gray-700 transition hover:text-gray-900" href="#"> Projects </a>
                </li>
                <li>
                  <a className="text-gray-700 transition hover:text-gray-900" href="#"> Contact </a>
                </li>
              </ul>
            </nav>
