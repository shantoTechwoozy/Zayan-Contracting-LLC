            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                        ...
                        <div className="col-span-2">
                            <div>
                                <Image
                                    ...
                                    width={240}
                                    height={60}
                                    className="w-full max-w-[150px] sm:max-w-[180px] md:max-w-[240px] lg:max-w-[300px]"
                                />
                ...
                <div className="mt-8 border-t border-gray-100 pt-8">
                    <div className="sm:flex sm:justify-between">
                        <p className="text-xs text-gray-500">&copy; 2024. Zayan Contracting LLC General Contractor. All rights reserved.</p>

                        <ul className="mt-8 flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end">
                            <li>
                                <a href="https://techwoozy.vercel.app/" className="text-gray-500 transition hover:opacity-75">Designed & Developed by
